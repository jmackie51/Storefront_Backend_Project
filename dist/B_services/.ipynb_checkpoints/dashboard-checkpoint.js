...
var DashboardQueries = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = 'SELECT firstName, lastName FROM users_table users INNER JOIN orders_table orders ON users.id = orders.user_id';
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("unable get users with orders: " + err_1);
    ...
    // Get all users that have made orders
    DashboardQueries.prototype.userOrder = function (user_id, status) {
        return __awaiter(this, void 0, void 0, function () {
