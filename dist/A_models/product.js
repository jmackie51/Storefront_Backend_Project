...
var ProductWarehouse = /** @class */ (function () {
    function ProductWarehouse() {
    }
    ProductWarehouse.prototype.index = function () {
    ...
    ProductWarehouse.prototype.show = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("Could not find products_table " + id + ". Error: " + err_2);
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    ProductWarehouse.prototype.create = function (p) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    ProductWarehouse.prototype.delete = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, conn, err_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        sql = 'DELETE FROM products_table WHERE id=($1)';
                        return [4 /*yield*/, database_1.default.connect()];
                    case 1:
                        conn = _a.sent();
                        return [4 /*yield*/, conn.query(sql, [id])];
