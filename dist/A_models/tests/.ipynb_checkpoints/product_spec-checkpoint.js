...
describe('Product Model', function () {
    ...
    it('create method should add a products', function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, productWarehouse.create({
                        name: 'Flower Pot',
                        price: 5.99,
                        category: 'Gardening',
                    })];
    ...
    it('index method should return a list of products', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, productWarehouse.index()];
                case 1:
                    result = _a.sent();
                    expect(result).toEqual([
                        {
    ...
    it('show method should return the correct product', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, productWarehouse.show('1')];
                case 1:
                    result = _a.sent();
                    expect(result).toEqual({
                        id: 1,
